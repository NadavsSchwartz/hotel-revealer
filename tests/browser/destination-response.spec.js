...
import { getDestination, searchDestinations } from '../../backend/destinations/index.js';
import { context } from './fixtures.js';

const destination = getDestination(context.destinationId);
const options = page => page.getByRole('listbox', { name: 'Destination suggestions' }).getByRole('option');
