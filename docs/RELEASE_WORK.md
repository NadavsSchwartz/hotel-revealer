...
live request is a milestone, not completion. Current application milestone: `6954d01`,
with pricing corrected in `62a47df`. See ACCEPTANCE.md for current evidence.
...
| Accessibility gaps | Named calendar controls; keyboard/error focus; non-jumping travelers; narrow layout checks | 200 browser cases covered across four configurations; manual AT still open |
...
| Local performance | Same-dimension mobile hero compressed; production text assets encoded; home-only preload | Three final LCP runs 2.352/2.144/2.160s; CLS 0.001181; no field percentile claim |
